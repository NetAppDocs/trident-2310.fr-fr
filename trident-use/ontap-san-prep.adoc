...
----
+
++ REMARQUE : Après l’exécution de cette commande, ONTAP vous invite à saisir un certificat. Collez le contenu du  `k8senv.pem` fichier généré à l’étape 1, puis appuyez sur  `END` pour terminer l’installation.
